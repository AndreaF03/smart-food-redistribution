    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .notif-bell:hover, .notif-bell.open { background: #f8fafc; border-color: #94a3b8; }
        .notif-badge {
        ...
        .alert-dismiss {
          ...
          padding: 0; color: inherit; flex-shrink: 0; transition: opacity 0.15s;
        }
        ...
        .ngo-info {
          ...
          font-size: 13px; color: #15803d; margin-bottom: 14px; line-height: 1.5;
        }
        ...
        .modal-close    {
          background: none; border: none; cursor: pointer;
          font-size: 22px; color: #94a3b8; line-height: 1; padding: 0; transition: color 0.15s;
        }
        ...
        .modal-rating-label  { font-size: 13px; font-weight: 600; color: #f59e0b; min-width: 70px; transition: opacity 0.15s; }
        ...
        .modal-textarea {
          ...
          resize: none; outline: none; transition: border-color 0.18s; background: #f8fafc;
        }
              ...
              return (
                <div key={item._id} className="r-card">
                  ...
                  <div className="r-card-meta">
                    ...
                    <span className="meta-pill">🌿 {score}% fresh</span>
